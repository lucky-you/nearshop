...
/**
 * Created by RayYeung on 2017/1/11.
 */
...
//        if (chatType == HxConstant.CHATTYPE_SINGLE) {
...
//        }
        ...
        titleBar.setBackgroundColor(getResources().getColor(R.color.title_grey));
        titleBar.setTitleColor(getResources().getColor(R.color.font_black));
        titleBar.setLeftImageResource(R.drawable.ic_arrow_left);
        // set click listener
...
//                }
    ...
    public void onSetMessageAttributes(EMMessage message) {
        ...
        if(userInfo!=null){
            message.setAttribute(ConstantValue.CHAT_NAME,userInfo.NickName);
            message.setAttribute(ConstantValue.CHAT_IMAGE,userInfo.UserPhoto);
        }
    }
