...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener
{
    ...
    private HashSet<Integer> mSelectedView = new HashSet<Integer>();
    private boolean mCanNoSelect;
...
//            lp.rightMargin = clp.rightMargin;
    ...
    public void doSelect(TagView child, int position)
    {
        if (mAutoSelectEffect)
        {
            ...
            {
                if(!mCanNoSelect&&mSelectedView.size() == 1)
                {
                    return;
                }
